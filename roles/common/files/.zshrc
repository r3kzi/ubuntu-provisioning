...
POWERLEVEL9K_DIR_HOME_BACKGROUND="135"

POWERLEVEL9K_CONTEXT_TEMPLATE="%n"

ZSH_AUTOSUGGEST_HIGHLIGHT_STYLE="fg=7,bg=clear,bold,underline"

plugins=(git gitfast kubectl aws helm zsh-autosuggestions)
